...
\begin{equation}
  ...
  \end{array} \right)
  \,.
  \nonumber%\label{mal:eq:Lorentzgen}
\end{equation}
%
...
\begin{figure}
    \centering
    \includegraphics[width=250pt]{malaise_source/erad.eps}
...
%
%Assuming that each single-star spacetime fulfills Einstein's equation in isolation and thus the Hamiltonian constraint from Eq. \ref{mal:eq:ham} is equal zero 
\begin{equation}
